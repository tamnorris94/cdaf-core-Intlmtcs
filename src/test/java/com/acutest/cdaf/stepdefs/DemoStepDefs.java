...
//    }
//
//    @Given("user browses to Azure Webpage as a SUT")
//    public void userBrowsesToSUT()
//    {
//        try {
//                driver.get("https://cdafwebapptesttarget2-dev-as.azurewebsites.net/index");
//    }
//        catch (NoSuchElementException e)
//        {
//            logger.error("Could not navigate to page");
//        }
//
//
//    }
//
//
//    @When("a check for the word {string} is performed for the landing page")
//    public void checkForWord(String word)
//    {
//        WebElement elmnt = driver.findElement(By.name(word));
//        String found = elmnt.getText();
//
//    }
...
//    }
//
//    @Then("the query matches the finding")
//    public void wordMatchCheck()
//    {
//        ;
//    }
